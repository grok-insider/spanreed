...
use crate::usage::formats::provider_identity::inferred_provider_from_model;
...
mod tests {
    ...
    fn utf8_bom_before_the_header_keeps_the_transcript() {
        ...
        for messages in [
            ...
            crate::usage::formats::sessions::senpi::parse_senpi_file(file.path()),
            crate::usage::formats::sessions::kimchi::parse_kimchi_file(file.path()),

...
export type ConsumptionReport = {
    ...
    daily: Array<ConsumptionTotal>;
    period_totals: Array<ConsumptionTotal>;
    clients: Array<ConsumptionTotal>;
    models: Array<ConsumptionTotal>;
    sessions: Array<ConsumptionTotal>;
    projects: Array<ConsumptionTotal>;
    records: Array<ConsumptionRecord>;
    records_truncated: boolean;
};
export type SynchronizedAccount = {
    linked_account_id: string | null;
    device: string;
    source: string;
    observed_at_ms: number;
    output: ProviderOutput;
    local_usage: LocalUsageSnapshot | null;
};
...
export type PrivateStoredObservation = {
    cursor: number;
    device: string;
    observation: PrivateObservation;
};
export type PrivateRecentPage = {
    observations: Array<PrivateStoredObservation>;
    before: number | null;
    has_more: boolean;
};
...
export type ResetInventory = {
    available: number;
    credits: Array<ResetCredit>;
    detailsComplete: boolean;
};
export type CreditBalance = {
    remainingUsd: number | null;
    subscriptionRemainingUsd: number | null;
    subscriptionLimitUsd: number | null;
    purchasedRemainingUsd: number | null;
...
export type MigrationInvitation = {
    id: string;
    secret: string;
    expiresAtMs: number;
};
export type MigrationSessionView = {
    id: string;
    ownerId: string;
...
export type MetricLine = {
    ...
    kind: MetricKind;
    label: string;
    points: Array<BarChartPoint>;
    note?: string;
    color?: string;
};
export type ProviderOutput = {
    resetInventory?: Observation<ResetInventory>;
    providerId: string;
    displayName: string;
    plan?: string;
    lines: Array<MetricLine>;
};

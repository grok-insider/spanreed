...
export declare function DropdownMenuCheckboxItem({ className, children, ...props }: StyledProps<BaseMenu.CheckboxItem.Props>): import("react").JSX.Element;
export declare function DropdownMenuRadioItem({ className, children, ...props }: StyledProps<BaseMenu.RadioItem.Props>): import("react").JSX.Element;

...
export declare function Badge({ className, tone, ...props }: ComponentProps<"span"> & {
    tone?: Tone;
}): import("react").JSX.Element;
export declare function Card({ className, ...props }: ComponentProps<"section">): import("react").JSX.Element;
...
export declare function TableHead(props: ComponentProps<"th">): import("react").JSX.Element;
export declare function TableCell(props: ComponentProps<"td">): import("react").JSX.Element;
export declare function TableCaption(props: ComponentProps<"caption">): import("react").JSX.Element;
export declare function TabsList({ className, ...props }: StyledProps<BaseTabs.List.Props>): import("react").JSX.Element;

...
export const remoteNavigation = [{id:"overview",label:"Overview"},{id:"usage",label:"Local consumption"},{id:"accounts",label:"Accounts"},{id:"routing",label:"Autosteer"},{id:"keys",label:"Proxy keys"},{id:"models",label:"Models"},{id:"requests",label:"Requests"},{id:"history",label:"Private history"},{id:"connections",label:"Connections"},{id:"migration",label:"Migration"},{id:"settings",label:"Settings"}];
...
function HostedConsumption() {
  const api=useRemote();
  const load=React.useCallback(()=>api<{snapshots:ConsumptionSnapshot[]}>("consumption",{}),[api]);
  return <SynchronizedConsumption load={load}/>;
}

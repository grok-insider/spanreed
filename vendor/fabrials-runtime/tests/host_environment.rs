...
use fabrials_runtime::upstreams::grok::{GrokAdapter, GrokClientIdentity};
...
fn relay_variables_do_not_change_the_grok_identity() {
    ...
    assert_eq!(header(&headers, "x-grok-client-identifier"), Some("grok-cli"));
}
...
fn host_supplied_identity_is_sent_upstream() {
    ...
    assert_eq!(header(&headers, "x-grok-client-identifier"), Some("fabrials-test"));
}
